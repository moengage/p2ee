from p2ee.orm.models.base import BaseField
from p2ee.orm.models.base.docs.meta import DocumentMetaClass
from p2ee.orm.models.exceptions import InvalidFieldException, InvalidFieldValueException
...
class SchemalessDocument(SimpleDocument):
    from moengage.models.fields import ObjectIdField
    _id = ObjectIdField()
